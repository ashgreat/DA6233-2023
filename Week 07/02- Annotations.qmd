...
## Rcessions annotation using Feds data

I downloaded the data as a CSV file from here: https://fred.stlouisfed.org/series/USREC. I saved it in my project folder in a subdirectory called "Data"

```{r}
rec_dt = read_csv(here::here("Data", "USREC.csv"))
```
...
```{r}
knitr::include_graphics(here::here("Images", "Screenshot 2023-10-03 at 10.45.27 PM.png"))
```
...
```{r}
p2 +
  geom_rect(data = recessions, aes(x = NULL, y = NULL, xmin = rec_start, xmax = rec_end, ymin = -Inf, ymax = Inf),
