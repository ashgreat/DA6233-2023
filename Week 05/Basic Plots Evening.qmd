...
```{r}
ggplot(mpg, aes(x = hwy)) +
  geom_histogram(bins = 15, color = "white", fill = "#CA1C1E", alpha = 0.7)
```
...
```{r}
ggplot(mpg, aes(x = hwy, y = cty)) +
  geom_point(color = "blue", fill = "red") +
  labs(x = "Highway mpg", y = "City mpg")
```
...
```{r}
ggplot(mpg, aes(x = hwy, y = cty)) +
  geom_point(shape = 21, color = "red", fill = "pink", size = 4) +
  labs(x = "Highway mpg", y = "City mpg")
```
